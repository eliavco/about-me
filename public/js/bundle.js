      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            alert(_context.t0.response.data.message); // console.log(err.response.data);
...
var DOMLoginForm = document.querySelector('.form');
...
if (DOMMap) {
  ...
  var locations = JSON.parse(DOMMap.dataset.locations); // values
